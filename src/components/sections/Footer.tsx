  ...
  return (
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-10">
      <div className="section-padding text-center">
        <p className="text-xl font-bold gradient-text mb-2">{cvData.name}</p>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">{cvData.title}</p>
        ...
        <p className="text-xs text-gray-400 dark:text-gray-600">
          © {currentYear} {cvData.name}. Built with Next.js & Tailwind CSS.
        </p>
      </div>
    </footer>
  );
